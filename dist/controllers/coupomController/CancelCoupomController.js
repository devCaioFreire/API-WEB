...
// src/controllers/coupomController/CancelCoupomController.ts
var CancelCoupomController_exports = {};
__export(CancelCoupomController_exports, {
  CancelCoupomController: () => CancelCoupomController
});
module.exports = __toCommonJS(CancelCoupomController_exports);
...
// src/services/coupomService/CancelCoupomService.ts
var CancelCoupomService = class {
  execute(cancelCupomRequest, token) {
    return __async(this, null, function* () {
      token = token.slice(7);
      const prisma = createPrismaClientFromJWT(token);
      const cancelCoupom = yield prisma.pedidos_venda.findMany({
        where: {
          status: "R"
        },
        take: 10,
...
// src/controllers/coupomController/CancelCoupomController.ts
var CancelCoupomController = class {
  handle(req, res) {
    return __async(this, null, function* () {
      const {
        id,
      ...
      const cancelCoupom = yield createCancelCoupomService.execute(
        {
          id,
          cpf_cnpj,
          valor_liquido,
