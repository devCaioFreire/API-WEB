...
// src/controllers/productController/filter/EANFilterController.ts
var EANFilterController_exports = {};
__export(EANFilterController_exports, {
  GetEANProductsController: () => GetEANProductsController
});
module.exports = __toCommonJS(EANFilterController_exports);
...
// src/services/productsService/filter/EANFilterService.ts
var GetEANProductsService = class {
  execute(ean, authorization) {
    return __async(this, null, function* () {
      var _a2;
      const prisma = createPrismaClientFromJWT(authorization);
      try {
        const codEAN = ean;
        const product = yield prisma.produtos.findFirst({
          where: { codEAN }
        });
        if (!product) {
          throw new Error("Produto n\xE3o encontrado");
        }
        const productWithBigIntToString = __spreadProps(__spreadValues({}, product), {
          id: product.id.toString(),
          id_sirius: ((_a2 = product.id_sirius) == null ? void 0 : _a2.toString()) || null
        });
...
// src/controllers/productController/filter/EANFilterController.ts
var GetEANProductsController = class {
  handle(req, res) {
    return __async(this, null, function* () {
      ...
      try {
        const product = yield eanProduct.execute(ean, authorization);
