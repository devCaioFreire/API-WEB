...
// src/controllers/productController/filter/DescriptionFilterController.ts
var DescriptionFilterController_exports = {};
__export(DescriptionFilterController_exports, {
  GetDescriptionProductsController: () => GetDescriptionProductsController
});
module.exports = __toCommonJS(DescriptionFilterController_exports);
...
// src/services/productsService/filter/DescriptionFilterService.ts
var GetDescriptionProductsService = class {
  execute(descricao, page, authorization) {
    return __async(this, null, function* () {
      const prisma = createPrismaClientFromJWT(authorization);
      try {
        const products = yield prisma.produtos.findMany({
          where: {
            descricao: {
              contains: descricao
            }
...
// src/controllers/productController/filter/DescriptionFilterController.ts
var GetDescriptionProductsController = class {
  handle(req, res) {
    return __async(this, null, function* () {
      ...
      try {
        const products = yield descriptionProduct.execute(descricao, page, authorization);
...
0 && (module.exports = {
  GetDescriptionProductsController
});
/*!
 *  decimal.js v10.4.3
