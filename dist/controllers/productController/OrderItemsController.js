...
// src/controllers/productController/OrderItemsController.ts
...
// src/services/productsService/OrderItemsService.ts
var OrderItemsService = class {
  get(token, selectors, params) {
    return __async(this, null, function* () {
      var _a2, _b;
      const prisma = createPrismaClientFromJWT(token);
      try {
        const query = { orderBy: { id: "asc" }, skip: 0, take: 1e3, where: {} };
        ...
        const orders = yield prisma.pedidos_venda_itens.findMany({ where: query.where, skip: query.skip, take: query.take, orderBy: query.orderBy });
        return orders;
      } catch (error) {
  ...
  handle(req, res) {
    return __async(this, null, function* () {
      ...
      if (filters != void 0 && filters != null) {
        ...
        const Order = yield orderItemsService.get(authorization, orderItemsService.ParamPropsFormater(ParamFilter), ParamConfig);
        if (!Order) {
