...
// src/controllers/productController/DeleteProductService.ts
var DeleteProductService_exports = {};
__export(DeleteProductService_exports, {
  DeleteProductController: () => DeleteProductController
});
module.exports = __toCommonJS(DeleteProductService_exports);
...
// src/services/productsService/DeleteProductService.ts
var DeleteProductService = class {
  execute(_0, _1) {
    return __async(this, arguments, function* ({ id }, token) {
      token = token.slice(7);
      const prisma = createPrismaClientFromJWT(token);
      const numericId = parseInt(id, void 0);
      const deleteProduct = yield prisma.produtos.delete({
        where: { id: numericId }
      });
      prisma.$disconnect;
...
var DeleteProductController = class {
  handle(req, res) {
    return __async(this, null, function* () {
      ...
      const product = yield deleteProduct.execute({ id });
