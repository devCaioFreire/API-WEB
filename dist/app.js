...
function getDatabaseConnectionStringForCompany(companyId) {
  return __async(this, null, function* () {
    const company = yield prismaAuth.empresas.findUnique({ where: { id: companyId } });
    const databaseConfig = `mysql://softclever:soft@1973@localhost:3306/${company == null ? void 0 : company.banco}?schema=public`;
...
var OrderController = class {
  getNextOrderNumberController(req, res) {
    return __async(this, null, function* () {
      try {
        ...
        const id = yield Service.getNextOrderNumber(token);
    ...
    return __async(this, null, function* () {
      try {
        ...
        return yield prisma.$transaction((prisma2) => __async(this, null, function* () {
          ...
          const balanceService = new BalanceService();
          const empresa = yield prismaAuth.empresas.findUnique({ where: { id: decodeToken(token).idCompany } });
          const _a2 = pedido, { itens } = _a2, pedidoInfo = __objRest(_a2, ["itens"]);
          const pedidoCreated = yield Service.create(pedidoInfo, prisma2);
          const dadosEmpresa = {
          ...
          yield itemService.create(itens != null ? itens : [], prisma2);
          yield balanceService.create(productMovimentacion, prisma2);
  ...
  getOrder(req, res) {
    return __async(this, null, function* () {
      try {
        const prisma = yield createPrismaClientFromJWT(getAuthorization(req.headers));
        const { ParamConfig, ParamFilter } = GetPropsAndFilters(req);
        const Service = new OrderService();
        const orders = yield Service.get(ParamFilter, ParamConfig, prisma);
    ...
    return __async(this, null, function* () {
      try {
        ...
        return yield prisma.$transaction((prisma2) => __async(this, null, function* () {
          ...
          const balanceService = new BalanceService();
          const order = yield Service.put(pedido, prisma2);
          const itens = yield itensService.get([{ field: "pedido_id", value: order.id }], [{ field: "take", value: "10000" }], prisma2);
          const productMovimentacion = [];
  ...
  getOrderRealized(req, res) {
    return __async(this, null, function* () {
      try {
        const prisma = yield createPrismaClientFromJWT(getAuthorization(req.headers));
        const Service = new OrderService();
        const orderRealizeded = yield Service.get([{ field: "status", value: "R" }], [{ field: "take", value: "10" }, { field: "orderBy", value: "data_criacao" }, { field: "OrderController", value: "desc" }], prisma);
  ...
  updateOrderStatus(req, res) {
    return __async(this, null, function* () {
      try {
        ...
        const token = getAuthorization(req.headers);
        const Service = new OrderService();
        const canceledOrder = yield Service.put(id, token);
  ...
  getOrderByPaymentMethod(req, res) {
    return __async(this, null, function* () {
      try {
        ...
        const prisma = yield createPrismaClientFromJWT(getAuthorization(req.headers));
        const Service = new OrderService();
        const pedidos = yield Service.get([{ field: "forma_pagamento", value: method }], [{ field: "take", value: "10000" }], prisma);
        const listId = [];
        pedidos.forEach((pedido) => {
          listId.push(pedido.id);
        });
        const PedidoResponse = [];
        if (listId.length > 0) {
          const itens = yield Service.getOrderByListId(listId, prisma);
  ...
  getOrderById(req, res) {
    return __async(this, null, function* () {
      try {
        ...
        const { ParamConfig, ParamFilter } = GetPropsAndFilters(req);
        const Service = new OrderService();
        const pedido = yield Service.get(ParamFilter, [{ field: "take", value: "1" }], prisma);
        const ItemService = new OrderItemService();
        const itens = yield ItemService.get([{ field: "pedido_id", value: pedido[0].id }], [{ field: "take", value: "10000" }], prisma);
...
var ProductController = class {
    ...
    return __async(this, null, function* () {
      try {
        ...
        if (error instanceof Error) {
          ...
          throw new ErrorResponse(500, "Erro Desconhecido");
        }
      }
    });
  }
  getProducts(req, res) {
    return __async(this, null, function* () {
      try {
        ...
        const { ParamConfig, ParamFilter } = GetPropsAndFilters(req);
        const Service = new ProductService();
        const products = yield Service.get(ParamFilter, ParamConfig, prisma);
  ...
  getAllProduct(req, res) {
    return __async(this, null, function* () {
      try {
        ...
        const Service = new ProductService();
        const products = yield Service.get([], [
  ...
  updateProduct(req, res) {
    return __async(this, null, function* () {
      try {
        ...
        const Service = new ProductService();
        const updatedProduct = yield Service.put(product, prisma);
  ...
  deleteProduct(req, res) {
    return __async(this, null, function* () {
      try {
        ...
        const Service = new ProductService();
        const deletedProduct = yield Service.delete(id, prisma);
  ...
  getLastProduct(req, res) {
    return __async(this, null, function* () {
      try {
        const prisma = yield createPrismaClientFromJWT(getAuthorization(req.headers));
        const Service = new ProductService();
        const product = yield Service.get([{ field: "order", value: "desc" }], [{ field: "take", value: "1" }], prisma);
  ...
  getProductByDescription(req, res) {
    return __async(this, null, function* () {
      try {
        const prisma = yield createPrismaClientFromJWT(getAuthorization(req.headers));
        ...
        const Service = new ProductService();
        const product = yield Service.get([{ field: "descricao", value: descricao }, { field: "status", value: "A" }], [{ field: "page", value: page }], prisma);
        return res.status(200).json(product);
      } catch (error) {
        console.log(error);
      }
  ...
  GetProductByEAN(req, res) {
    return __async(this, null, function* () {
      try {
        const prisma = yield createPrismaClientFromJWT(getAuthorization(req.headers));
        const ean = req.params.ean;
        const Service = new ProductService();
        const product = yield Service.get([{ field: "codEAN", value: ean }, { field: "status", value: "A" }], [{ field: "take", value: 1 }], prisma);
        console.log(product);
        return res.status(200).json(product);
      } catch (error) {
        console.log(error);
